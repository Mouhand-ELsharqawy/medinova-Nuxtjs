        ...
        <div class="container">
            <div class="row gx-5">
                <div class="col-lg-6 mb-5 mb-lg-0">
                    ...
                    <NuxtLink class="btn btn-primary rounded-pill py-3 px-5 me-3" to="">Find Doctor</NuxtLink>
                    <NuxtLink class="btn btn-outline-primary rounded-pill py-3 px-5" to="">Read More</NuxtLink>
                </div>
                <div class="col-lg-6">
