<template>
   ...
   <div class="row g-5">
            <div class="col-lg-8">
                ...
                <div class="mb-5">
                    <img class="img-fluid w-100 rounded mb-5" src= "../assets/img/blog-2.jpg" alt="">
                    ...
                    <div class="d-flex justify-content-between bg-light rounded p-4 mt-4 mb-4">
                        <div class="d-flex align-items-center">
                            <img class="rounded-circle me-2" src= "../assets/img/user.jpg" width="40" height="40" alt="">
                            <span>John Doe</span>
                        </div>
                        <div class="d-flex align-items-center">
                ...
                <div class="mb-5">
                    ...
                    <div class="d-flex mb-4">
                        <img src= "../assets/img/user.jpg" class="img-fluid rounded-circle" style="width: 45px; height: 45px;">
                        <div class="ps-3">
                            <h6><NuxtLink to ="">John Doe</NuxtLink> <small><i>01 Jan 2045</i></small></h6>
            ...
            <div class="col-lg-4">
                ...
                <div class="mb-5">
                    ...
                    <div class="d-flex flex-column justify-content-start">
                        <NuxtLink class="h5 bg-light rounded py-2 px-3 mb-2" to ="#"><i class="fa fa-angle-right me-2"></i>Web Design</NuxtLink>
                        <NuxtLink class="h5 bg-light rounded py-2 px-3 mb-2" to ="#"><i class="fa fa-angle-right me-2"></i>Web Development</NuxtLink>
                        <NuxtLink class="h5 bg-light rounded py-2 px-3 mb-2" to ="#"><i class="fa fa-angle-right me-2"></i>Web Development</NuxtLink>
                        <NuxtLink class="h5 bg-light rounded py-2 px-3 mb-2" to ="#"><i class="fa fa-angle-right me-2"></i>Keyword Research</NuxtLink>
                        <NuxtLink class="h5 bg-light rounded py-2 px-3 mb-2" to ="#"><i class="fa fa-angle-right me-2"></i>Email Marketing</NuxtLink>
                    </div>
                </div>
                ...
                <div class="mb-5">
                    ...
                    <div class="d-flex rounded overflow-hidden mb-3">
                        ...
                        <NuxtLink to ="" class="h5 d-flex align-items-center bg-light px-3 mb-0">Lorem ipsum dolor sit amet consec adipis elit
                        </NuxtLink>
                    </div>
                    <div class="d-flex rounded overflow-hidden mb-3">
                ...
                <div class="mb-5">
                    ...
                    <div class="d-flex flex-wrap m-n1">
                        <NuxtLink to ="" class="btn btn-primary m-1">Design</NuxtLink>
                        <NuxtLink to ="" class="btn btn-primary m-1">Development</NuxtLink>
                        <NuxtLink to ="" class="btn btn-primary m-1">Marketing</NuxtLink>
                        <NuxtLink to ="" class="btn btn-primary m-1">SEO</NuxtLink>
                        <NuxtLink to ="" class="btn btn-primary m-1">Writing</NuxtLink>
                        <NuxtLink to ="" class="btn btn-primary m-1">Consulting</NuxtLink>
                        <NuxtLink to ="" class="btn btn-primary m-1">Design</NuxtLink>
                        <NuxtLink to ="" class="btn btn-primary m-1">Development</NuxtLink>
                        <NuxtLink to ="" class="btn btn-primary m-1">Marketing</NuxtLink>
                        <NuxtLink to ="" class="btn btn-primary m-1">SEO</NuxtLink>
                ...
                <div>
                    ...
                    <div class="bg-light rounded text-center" style="padding: 30px;">
                        ...
                        <NuxtLink to ="" class="btn btn-primary py-2 px-4">Read More</NuxtLink>
                    </div>
                </div>
